...
class ListDoubleCard extends React.Component {
    render() {
        ...
        return (
            <article className={this.props.toTheRight?'right':'null'}>
                ...
                <div>
                {this.props.h3
                    ?<h3 className={this.props.linked?'link':null}>{this.props.h3}</h3>
                    :null}
                <p>
                {
