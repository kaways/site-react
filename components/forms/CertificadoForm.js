...
class CertificadoForm extends React.Component {
    constructor(props) {
        super(props);
    ...
    onSubmit(e) {
        ...
        if( !(this.state.enviando) && this.state.nomeOk && this.state.emailOk && this.state.foneOk ) {
            ...
            axios.post("/querocertificado", formData, config)
            .then((result) => {
                if ( result ) {
                    // console.log(result)
                } else {
    ...
    formSuccessHandle() {
        // dataLayer.push({'event': 'formSubmitted', 'formName': 'Certificado Digital'});
            ...
            <div id="register-wrapper" className={this.state.visible}>
                ...
                <style jsx>{`
                    ...
                    form#form_experimente {
                        ...
                        background: radial-gradient(circle at top right,rgb(79, 195, 93) 30%,rgb(44, 150, 57) 90%);
                    ...
                    form#form_experimente button {
                        ...
                        border: 0;
                        border-radius: 20px;
                        background-color:rgb(23, 70, 118);
                        color:#ffffff;
                        font-weight:600;
                        cursor:pointer;
                    }
