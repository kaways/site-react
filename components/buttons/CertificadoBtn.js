import CertificadoForm from '../forms/CertificadoForm';

class CertificadoBtn extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        return (
            <div className={this.props.mod}>
                ...
                {this.state.visible ? <CertificadoForm closeform={this.handleFormUnmount} emailvalue={this.state.emailPre} /> : null}
                <style jsx>{`
                    div {
