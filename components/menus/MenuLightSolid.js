...
class MenuDarkSolid extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            menuSticky: 'menu',
                    ...
                    <div className="menuControl" onClick={this.menuToggle}><span></span><span></span><span></span></div>
                        <div className={'menuItems ' + this.state.menuOpen}>
                            ...
                            <a href="https://app.vhsys.com.br/" className="entrar">
                                ...
                                <img alt='entrar' title='entrar' width="150px" height="40px" src={require("../../static/images/vetor/icons/entrar.svg")} />
                            </a>
                        </div>
                    </div>
                </article>
