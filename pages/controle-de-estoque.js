    ...
    render() {
        return (
            <div>
                ...
                <MenuLight />
                <HeaderCatFunc 
                    imgName='controle-de-estoque'
                    h1n='Controle de Estoque'
                    subtitulo='Faça o controle de estoque online, integrado ao vendas e financeiro direto do sistema de gestão VHSYS.'
                    headerStyle='estoque grayMask'
                    breadcrumbs={
                    ...
                    <ul>
                        ...
                        <li><>Diminuição de custos de armazenagem de produtos;</></li>
                        <li><>Redução de tempo gasto em rotinas administrativas;</></li>
                        <li><>Alerta de estoque mínimo;</></li>
                        <li><>Nota Fiscal de Entrada;</></li>
                        <li><>Cadastro de produtos, fornecedores e transportadoras;</></li>
                        <li><>Redução de desperdícios e gastos;</></li>
                        <li><>Melhora no nível de serviço e satisfação do cliente.</></li>
                    </ul>
                </HeaderCatFunc>
